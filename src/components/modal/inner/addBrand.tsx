...
import createBrand from "Apis/adminApi/createBrand";
import { setBrands } from "@/store/slices/perfume";
...
const AddBrand: React.FC<Props> = ({ closeModal }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const brands = await createBrand(formData);
      Swal.fire("성공", "브랜드 생성에 성공하였습니다. ", "success");
      closeModal();
